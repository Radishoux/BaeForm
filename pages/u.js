...
// 			<input style={{display:"none"}} type="number" id="backage" class="profinput" placeholder="Age" maxlength="2"/>

// 			<select style={{display:"none"}} id="backcountry" name="country" class="custom-select">
...
// 			<select style={{display:"none"}} id="backsex" name="sex" class="custom-select">
...
// 			<p style={{textAlign: "left", fontSize: "1.5em", borderBottom: "1px solid red"}} id="from">from : {me["from"].S}</p>
// 			<p style={{textAlign: "left", fontSize: "1.5em", borderBottom: "1px solid red"}} id="age">age : {me["age"].N}</p>
// 			<p style={{textAlign: "left", fontSize: "1.5em", borderBottom: "1px solid red"}} id="sex">sex : {me["sex"].S}</p>
// 			<br></br>
...
// 			<br></br>
// 			<p style={{textAlign: "left", fontSize: "1.5em", borderBottom: "1px solid red"}}>Submitted</p>
// 			<div id="submits">
// 			<div className="subraw">
// 			<p>Pile<br/>Face</p>
// 			<p>PVotes<br/>FVotes</p>
// 			<p>👍<br/>👎</p>
// 			</div>
// 			</div>
// 			<p style={{textAlign: "left", fontSize: "1.5em", borderBottom: "1px solid red"}}>Votted</p>
// 			<div id="votes">
// 			<div className="votraw">
// 			<p>Pile<br/>Face</p>
// 			<p>PVotes<br/>FVotes</p>
// 			<p>👍<br/>👎</p>
// 			<p>Made By</p>
